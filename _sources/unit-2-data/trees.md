...
* [Non-linear data structures](content:references:non-linear-data-structures) store and manage data in more complex ways, allowing for faster access and manipulation of data, especially data with hierarchical relationships. We'll discuss dictionaries (hashmaps) and sets, trees, and graphs as examples of non-linear data structures.

We'll also introduce approaches for data access in trees and graphs, such as [depth-first](content:references:data-structure-graphs-depth-first) and [breadth-first](content:references:data-structure-graphs-breadth-first) search algorithms. 
```
...
Then we'll move on to non-linear data structures:
...
Finally, we'll also introduce approaches for data access in trees and graphs:
...
(content:references:linear-data-structures)=
## Linear data structures
Linear data structures store elements linearly, meaning that they are arranged in a sequence one after the other. This contrasts with non-linear data structures, which do not have a strict sequential order. We'll discuss [arrays](content:references:lda-arrays), [stacks](content:references:lda-stacks), [queues](content:references:lda-queues), and [linked lists](content:references:lda-linked-lists) as examples of linear data structures.
...
```{figure} ./figs/Fig-Array-Schematic.png
---
height: 90px
...
```{figure} ./figs/Fig-Queue-Schematic.png
---
height: 200px
...
```{figure} ./figs/Fig-LinkedList-Schematic.png
---
height: 180px
...
(content:references:non-linear-data-structures)=
## Non-linear data structures
Non-linear data structures store and manage data in more complex ways, allowing for faster access and manipulation of data, especially data with hierarchical relationships.  However, non-linear data structures are typically more complex to construct and require more memory to store data. We'll consider a few handy non-linear data structures, {ref}`content:references:data-structure-hashmap-and-sets`, {ref}`content:references:data-structure-tree`, and {ref}`content:references:data-structure-graphs`.
...
```{figure} ./figs/Fig-Graph-Schematic.png
---
height: 220px
...
* [Linear data structures](content:references:linear-data-structures) are data structures that store data in a linear sequence, such as arrays, stacks, and queues. They are used to store and access data in a sequential manner.
* [Non-linear data structures](content:references:non-linear-data-structures) are data structures that store data in a non-linear manner, such as trees and graphs. They are used to represent hierarchical relationships and complex networks of data.
